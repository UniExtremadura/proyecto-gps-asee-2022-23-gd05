...
public class CU15 {
    ...
    public void cU15() {
        ...
        ViewInteraction bottomNavigationItemView = onView(
                allOf(withId(R.id.page_3), withContentDescription("Users"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.commandRecyclerView),hasSibling(withId(R.id.title_command_record))));
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.user_name),
                        withParent(allOf(withId(R.id.userDetailScreen),
                                withParent(withId(R.id.content_to_do_manager)))),
                        isDisplayed()));

        String name = getText(withId(R.id.user_name));
        String server = getText(withId(R.id.server_name));

        pressBack();
        recyclerView
                .check(matches(atPosition(0, hasDescendant(withText(name)))));

        onView(allOf(withId(R.id.commandRecyclerView),hasSibling(withId(R.id.title_command_record)))).perform(
                RecyclerViewActions.actionOnItem(
                        Matchers.allOf(hasDescendant(withText(name)), hasDescendant(withText(server))), click()));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.server_name),
                        withParent(allOf(withId(R.id.userDetailScreen),
                                withParent(withId(R.id.content_to_do_manager)))),
                        isDisplayed()));
        textView3.check(matches(withText(server)));
