...
public class CU07 {
    ...
    public void cU07() {
        ...
        onView(withId(R.id.deleteAllCommands)).perform(click());
        onView(isRoot()).perform(waitFor(1000));
        onView(withId(R.id.commandRecyclerView)).check(matches(hasChildCount(0)));
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.command_name), withText("Test"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.content_to_do_manager),
                                        5),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.command_trigger), withText("Seleccionar trigger"),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("a"));

        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.command_trigger), withText("a"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.content_to_do_manager),
                                        5),
        ...
        onView(withId(R.id.commandRecyclerView)).check(matches(hasChildCount(1)));
